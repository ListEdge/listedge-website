// ============================================================================
// /api/edge  —  Edge V2 reasoning endpoint (Vercel serverless function)
//
// The browser sends a small, PII-free "facts" object; this function asks OpenAI
// to write the briefing and returns JSON that matches Edge's briefing contract.
//
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    var system = [
      "You are Edge, the founder's AI chief-of-staff inside a real-estate CRM called Founder HQ.",
